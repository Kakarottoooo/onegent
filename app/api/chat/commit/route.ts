...
export async function POST(req: NextRequest) {
  ...
  if (intent === "create_plan") {
    ...
    return NextResponse.json({
      ...
      // deterministic English handoff for legacy /api/chat parsers; reparsing
      // the original Chinese booking sentence has regressed to dropped fields
      // and false "no results" outcomes.
      search_query:
