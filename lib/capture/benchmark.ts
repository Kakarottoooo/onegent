...
function buildActivityFixtures(): CaptureBenchmarkFixture[] {
  ...
  fixtures.push(
    ...
    activityProviderUrlFixture({
      id: "activity-provider-ticketmaster-lil-wayne-artist-01",
      ...
      dogfoodId: "DOG-activity-provider-url",
    }),
    activityProviderUrlFixture({
      id: "activity-provider-ticketmaster-kacey-musgraves-artist-01",
      url: "https://www.ticketmaster.com/kacey-musgraves-tickets/artist/1668663?ac_link=ntm_kaceymusgraves26-1_spotlight_1",
      provider: "ticketmaster",
      pageType: "artist",
      providerPageId: "1668663",
      titleHint: "Kacey Musgraves",
      executionMode: "provider_start",
      needsUserChoice: true,
    }),
    activityProviderUrlFixture({
      id: "activity-provider-ticketmaster-foster-the-people-artist-01",
      url: "https://www.ticketmaster.com/foster-the-people-tickets/artist/1478293?ac_link=NTM_FosterThePeople26-1_spotlight_1",
      provider: "ticketmaster",
      pageType: "artist",
      providerPageId: "1478293",
      titleHint: "Foster The People",
      executionMode: "provider_start",
      needsUserChoice: true,
    }),
    activityProviderUrlFixture({
      id: "activity-provider-ticketmaster-westminster-artist-01",
      url: "https://www.ticketmaster.com/westminster-kennel-club-dog-show-tickets/artist/847597",
      provider: "ticketmaster",
      pageType: "artist",
      providerPageId: "847597",
      titleHint: "Westminster Kennel Club Dog Show",
      executionMode: "provider_start",
      needsUserChoice: true,
    }),
    activityProviderUrlFixture({
      id: "activity-provider-ticketmaster-monster-jam-artist-01",
      url: "https://www.ticketmaster.com/monster-jam-tickets/artist/1542376",
      provider: "ticketmaster",
      pageType: "artist",
      providerPageId: "1542376",
      titleHint: "Monster Jam",
      executionMode: "provider_start",
      needsUserChoice: true,
    }),
    activityProviderUrlFixture({
      id: "activity-provider-ticketmaster-disney-on-ice-artist-01",
      url: "https://www.ticketmaster.com/disney-on-ice-presents-find-your-tickets/artist/1742147",
      provider: "ticketmaster",
      pageType: "artist",
      providerPageId: "1742147",
      titleHint: "Disney On Ice Presents",
      executionMode: "provider_start",
      needsUserChoice: true,
    }),
    activityProviderUrlFixture({
      id: "activity-provider-stubhub-olivia-rodrigo-performer-01",
    ...
    activityProviderUrlFixture({
      id: "activity-provider-stubhub-world-cup-grouping-01",
    ...
    activityProviderUrlFixture({
      id: "activity-provider-stubhub-nba-playoffs-grouping-01",
      url: "https://www.stubhub.com/nba-playoffs-tickets/grouping/107517",
      provider: "stubhub",
      pageType: "grouping",
      providerPageId: "107517",
      titleHint: "NBA Playoffs",
      executionMode: "provider_start",
      needsUserChoice: true,
    }),
    activityProviderUrlFixture({
      id: "activity-provider-stubhub-bts-performer-01",
    ...
    activityProviderUrlFixture({
      id: "activity-provider-seatgeek-r-and-b-tour-listing-01",
      url: "https://seatgeek.com/the-r-and-b-tour-tickets?_gl=1*1go2jz9*_up*MQ..*_gs*MQ..",
      provider: "seatgeek",
      pageType: "provider_listing",
      providerPageId: "the-r-and-b-tour-tickets",
      titleHint: "The R And B Tour",
      executionMode: "provider_start",
      needsUserChoice: true,
    }),
    activityProviderUrlFixture({
      id: "activity-provider-seatgeek-nashville-sc-event-01",
    ...
    activityProviderUrlFixture({
      id: "activity-provider-seatgeek-chris-stapleton-event-01",
      url: "https://seatgeek.com/chris-stapleton-tickets/nashville-tennessee-nissan-stadium-2026-05-23-6-pm/concert/17990981",
      provider: "seatgeek",
      pageType: "exact_event",
      providerPageId: "17990981",
      titleHint: "Chris Stapleton",
      executionMode: "direct_execution",
      needsUserChoice: false,
    }),
    activityProviderUrlFixture({
      id: "activity-provider-seatgeek-hamilton-listing-01",
    ...
    activityProviderUrlFixture({
      id: "activity-provider-seatgeek-leanne-morgan-event-01",
      url: "https://seatgeek.com/leanne-morgan-tickets/comedy/2026-12-11-7-pm/18140651",
      provider: "seatgeek",
      pageType: "exact_event",
      providerPageId: "18140651",
      titleHint: "Leanne Morgan",
      executionMode: "direct_execution",
      needsUserChoice: false,
    }),
...
function activityProviderUrlFixture(input: {
  id: string;
  url: string;
  provider: "ticketmaster" | "stubhub" | "seatgeek" | "eventbrite";
  pageType: "exact_event" | "artist" | "performer" | "grouping" | "search_results" | "provider_listing";
  ...
  return baseFixture({
    ...
    expectedSourceType: "url",
    expectedEntityPaths: {
      "source.resolved_link.provider": input.provider,
      "source.resolved_link.page_type": input.pageType,
      "source.resolved_link.provider_page_id": input.providerPageId,
      "source.resolved_link.title_hint": input.titleHint,
      "source.resolved_link.execution_mode": input.executionMode,
      "source.resolved_link.needs_user_choice": input.needsUserChoice,
      "constraints.source_provider": input.provider,
      "constraints.source_page_type": input.pageType,
      "constraints.source_execution_mode": input.executionMode,
      "constraints.source_needs_user_choice": input.needsUserChoice,
      "constraints.provider": input.provider,
      "constraints.provider_page_type": input.pageType,
      "constraints.provider_page_id": input.providerPageId,
      "constraints.title_hint": input.titleHint,
    },
    expectedActionTypes: ["save", "preview_task"],
    expectedTaskReadiness: { ready: false, reason: "needs_review", missing: [] },
    owner: "capture",
    expectedFailureClass: "none",
    dogfoodId: input.dogfoodId,
    parserState: undefined,
    note: `Locks ${input.provider} ${input.pageType} URL capture as ${input.executionMode} with user-choice=${input.needsUserChoice}.`,
  });
}
