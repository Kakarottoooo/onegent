...
describe("docs static guard - phase2", () => {
  it("links demo freeze acceptance and Phase 2 posture from demo readiness", () => {
    ...
    expect(page).toContain("docs/90-archive/phase1-demo/DEMO_FREEZE_ACCEPTANCE.md");
    expect(page).toMatch(/Phase 2.*not live verified/i);
    expect(helper).toContain("docs/90-archive/phase1-demo/DEMO_FREEZE_ACCEPTANCE.md");
    expect(helper).toContain("docs/90-archive/phase1-demo/YC_DEMO_OPERATOR_CARD.md");
  });
