...
From `EXECUTOR_V2_PIVOT.md` and the user's strategic discussion:
...
```
"We benchmarked 100 real NYC restaurant cases (BENCHMARK_RESTAURANT_100.md
...
- Phase context: [EXECUTOR_V2_PIVOT.md](./EXECUTOR_V2_PIVOT.md)
- Task runtime design: [TASK_RUNTIME_DESIGN.md](./TASK_RUNTIME_DESIGN.md)
