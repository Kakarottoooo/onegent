...
> **Phase**: 1 of 5 (per [docs/90-archive/old-provider-plans/EXECUTOR_V2_PIVOT.md](./EXECUTOR_V2_PIVOT.md))
...
- **Pivot context**: [docs/90-archive/old-provider-plans/EXECUTOR_V2_PIVOT.md](./EXECUTOR_V2_PIVOT.md)
...
*This is a Phase 1-only design. Phases 2-5 will get their own design docs as they're queued. Resist the urge to design the 5-year OS in this file — that's [docs/90-archive/old-provider-plans/EXECUTOR_V2_PIVOT.md](./EXECUTOR_V2_PIVOT.md)'s job.*
